...
export function CommunityStation({ abordaje }: CommunityStationProps) {
    const comunidad = abordaje.comunidad;
            ...
            <div className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Información de la comunidad visitada en este abordaje
                    </p>
                </div>
            </div>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {comunidad.observaciones && (
                            <div className="pt-4 border-t">
                                <h4 className="font-semibold text-sm text-gray-500 uppercase mb-2">Observaciones</h4>
