    ...
    const handleEditClick = async (row: any) => {
        ...
        try {
            ...
            setWizardInitialData({
                ...
                cirugiasPrevias: antRes.data?.cirugiasPrevias || '',
                medicamentosActuales: antRes.data?.medicamentosActuales || '',
                peso: row.consulta.peso ? String(row.consulta.peso) : '',
                talla: row.consulta.talla ? String(row.consulta.talla) : '',
                temperatura: row.consulta.temperatura ? String(row.consulta.temperatura) : '',
                FC: row.consulta.frecuenciaCardiaca || '',
                TA: row.consulta.tensionArterial || '',
